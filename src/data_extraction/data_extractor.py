import time
import os
from data_extraction.gaussian_reader import gaussian_reader
from sys import stdout
from data_extraction.gaussian_coordinates_extractor import gaussian_coordinates_extractor
from data_extraction.gaussian_nbo_extractor import gaussian_nbo_extractor
from data_extraction.gaussian_connectivity_extractor import gaussian_connectivity_extractor
...
def data_extractor(input_dir, esp_charges_dir='no_esp'):
    ...
    if esp_charges_dir == 'inside':
        print("\nExtracting ESP charges...")
        esp_charges_list = []
        current_file = 0
        dir_path_esp = os.path.join(path, input_dir)
